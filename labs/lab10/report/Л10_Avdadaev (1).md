...
![Создание файлов для лабораторной работы]![Alt text](<1 фото-2.png>)

Ввожу в файл lab10-1.asm текст программы, записывающей в файл сообщения, из листинга 10.1. 

![Ввод текста программы из листинга 10.1]![Alt text](image2.png) 

Создаю исполняемый файл и проверяю его работу. 

![Запуск исполняемого файла]![Alt text](image3.png)

Далее с помощью команды chmod u-х изменяю права доступа к исполняемому файлу lab10-1,
запретив его выполнение и пытаюсь выполнить файл. 

![Запрет на выполнение файла]![Alt text](image4.png)

Файл не выполняется, т.к в команде я указала "u" - владелец (себя), "-" - отменить набор прав, "х" - право на исполнение.

С помощью команды chmod u+х изменяю права доступа к файлу lab10-1.asm с исходным текстом программы, добавив права на исполнение, и пытаюсь выполнить его. 

![Добавление прав на исполнение]![Alt text](image5.png)
...
И проверяю правильность выполнения с помощью команды ls -l. 

![Предоставление прав доступа в символьном и двоичном виде]![Alt text](image6.png)
![Alt text](image8.png)
![Alt text](image7.png)
## **Задание для самостоятельной работы**

Пишу код программы, выводящей приглашения “Как Вас зовут?”, считывающей с клавиатуры фамилию и имя и создающую файл, в который записывается сообщение “Меня зовут "ФИ"”.

![Написание текста программы]![Alt text](image9.png)
...
![Запуск исполняемого файла и проверка его работы]![Alt text](image10.png)
